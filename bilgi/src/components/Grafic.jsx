                                                        ...
                                                        <div className='flex'>
                                                            ...
                                                            <div className='flex flex-col justify-between text-start ml-[10px] py-[5px]'>
                                                                ...
                                                                <p className='text-[#FA6C1C] text-[14px] font-[400] w-[71px]'>
                                                                    ...
                                                                    pul
                                                                    to’lamaysiz</p>
                                                                <h3 className='text-[14px] font-[700] leading-[20.50px]'>4-oy <span className='text-[#000000B2] text-[14px] font-[400] ml-[4px]'>Dars tugadi</span></h3>
                                                                <p className='text-[#FA6C1C] text-[14px] font-[400] '>2 oy
                                                                    qo’shimcha
                                                                    muddat, bu paytda ham pul to’lamaysiz</p>
                                                                <h3 className='text-[14px] font-[700] text-[#FA6C1C] leading-[20.50px]'>6-oydan keyin <span className='text-[#FA6C1C] text-[14px] font-[400] ml-[4px]'>Pul to’lashni boshlaysiz</span></h3>
                                                            </div>
                                                        </div>
                                                        <div className='mt-[25px]'>
                                                            <div className='flex mt-[7px]'>
                                                                ...
                                                                <div className='text-start w-full bg-[#F7F7F7] rounded-[15px] p-[8px] ml-[5px]'>
                                                                    <h2 className='text-[12px] flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Umumiy kurs narxi: <span className='text-[16px] leading-[28px] font-[400] text-[#01101C]'>6 450 000 UZS</span></h2>
                                                                    <hr className='mt-[7px]' />
                                                                    <h2 className='text-[12px]  flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Oyiga: <span className='text-[16px] leading-[28px] font-[800] text-[#01101C]'>1 075 000 UZS</span></h2>
                                                                </div>
                                                            </div>
                                                            <div className='flex mt-[7px]'>
                                                                ...
                                                                <div className='text-start w-full bg-[#F7F7F7] rounded-[15px] p-[8px] ml-[5px]'>
                                                                    <h2 className='text-[12px] flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Umumiy kurs narxi: <span className='text-[16px] leading-[28px] font-[400] text-[#01101C]'>6 900 000 UZS</span></h2>
                                                                    <hr className='mt-[7px]' />
                                                                    <h2 className='text-[12px]  flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Oyiga: <span className='text-[16px] leading-[28px] font-[800] text-[#01101C]'>575 000 UZS</span></h2>
                                                                </div>  
                                                            </div>
                                                            <div className='flex mt-[7px]'>
                                                                ...
                                                                <div className='text-start w-full bg-[#F7F7F7] rounded-[15px] p-[8px] ml-[5px]'>
                                                                    <h2 className='text-[12px] flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Umumiy kurs narxi: <span className='text-[16px] leading-[28px] font-[400] text-[#01101C]'>7 350 000 UZS</span></h2>
                                                                    <hr className='mt-[7px]' />
                                                                    <h2 className='text-[12px]  flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Oyiga: <span className='text-[16px] leading-[28px] font-[800] text-[#01101C]'>408 000 UZS</span></h2>
                                                                </div>
                                                            </div>
