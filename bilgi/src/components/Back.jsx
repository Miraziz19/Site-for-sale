...
export default function Back() {
    ...
    const { page, setPage, reg, setReg } = useContext(Context);
                                    ...
                                    course.id == page && <div key={course.id}>
                                        ...
                                        <div className='mt-[25px]'>
                                            <div className='flex mt-[7px]'>
                                                <h2 className='bg-[#F7F7F7] pt-[15px] w-[50px] text-[18px] font-[700] lending-[32px]  px-[18px] rounded-[15px]'>6 <span className='block text-[12px] font-[400] lending-[14.32px] text-[#01101C]'>oy</span></h2>
                                                <div className='text-start p-[8px] w-full bg-[#F7F7F7] rounded-[15px]   ml-[5px]'>
                                                    <h2 className='text-[12px] flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Umumiy kurs narxi: <span className='text-[16px] leading-[28px] font-[400] text-[#01101C]'>12 900 000 UZS</span></h2>
                                                    <hr className='mt-[6px]' />
                                                    <h2 className='text-[12px]  flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Oyiga: <span className='text-[16px] leading-[28px] font-[800] text-[#01101C]'>2 150 000 UZS</span></h2>
                                                </div>
                                            </div>
                                            <div className='flex mt-[7px]'>
                                                ...
                                                <div className='text-start w-full bg-[#F7F7F7] rounded-[15px] p-[8px] ml-[5px]'>
                                                    <h2 className='text-[12px] flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Umumiy kurs narxi: <span className='text-[16px] leading-[28px] font-[400] text-[#01101C]'>13 800 000 UZS</span></h2>
                                                    <hr className='mt-[7px]' />
                                                    <h2 className='text-[12px]  flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Oyiga: <span className='text-[16px] leading-[28px] font-[800] text-[#01101C]'>1 150 000 UZS</span></h2>
                                                </div>
                                            </div>
                                            <div className='flex mt-[7px]'>
                                                ...
                                                <div className='text-start w-full bg-[#F7F7F7] rounded-[15px] p-[8px] ml-[5px]'>
                                                    <h2 className='text-[12px] flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Umumiy kurs narxi: <span className='text-[16px] leading-[28px] font-[400] text-[#01101C]'>14 700 000 UZS</span></h2>
                                                    <hr className='mt-[7px]' />
                                                    <h2 className='text-[12px]  flex justify-between font-[400] leading-[14.32px] tracking-[-1%] text-[#01101C99] items-center'>Oyiga: <span className='text-[16px] leading-[28px] font-[800] text-[#01101C]'>816 000 UZS</span></h2>
                                                </div>
                                            </div>
